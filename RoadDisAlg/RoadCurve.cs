...
namespace RoadDisAlg
{
    ...
    public class RoadCurve
    {
        ...
        public void Comab()
        {
            ...
            f = this.ComA();
            this.A = AlgElasticBeamFEM.A * f;
            f = this.ComI();
            this.I = AlgElasticBeamFEM.I * f;
            this.E = this.Road.RoadGrade.E;
        }
        ...
        private double ComI()
        {
            double c = AlgElasticBeamFEM.c;

            double k1 = AlgElasticBeamFEM.k1;
            double k2 = AlgElasticBeamFEM.k2;
            double f = 0;
            if (k >= k1 && k <= k2)
            {
                    f = 1;
        ...
        {
            double c = AlgElasticBeamFEM.c;
            double c1 = AlgElasticBeamFEM.c1;
            double k1 = AlgElasticBeamFEM.k1;
            double k2 = AlgElasticBeamFEM.k2;
            double f = 0;
            if (k >= k1 && k <= k2)
