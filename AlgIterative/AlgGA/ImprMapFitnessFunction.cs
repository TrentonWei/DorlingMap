...
namespace AlgIterative.AlgGA
{
    ...
    /// 适应度函数,对应改进后的算法
    /// </summary>
    public class ImprMapFitnessFunction : IFitnessFunction
    {
        public  SDS Map = null;
        ...
        public ImprMapFitnessFunction(SDS map, 
        ...
        public double ConflictCost(IChromosome chromosome)
        {
            ...
            ushort[] state = ((ImprMapChromosome)chromosome).Value;
            ...
            ((ImprMapChromosome)chromosome).ConflictsNo = clist.Count;
            conflictCost = CostFunction(clist, state);
            ((ImprMapChromosome)chromosome).ConflictsCost = conflictCost;
