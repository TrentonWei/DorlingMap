    ...
    public partial class StableDorlingMapFrm : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            for (int i = LevelLabel.Count - 1; i >= 0; i--)
            {
                ...
                {
                    DM.StableDorlingBeams(PgLists[j], MapLists[j], 1, 10, 1, 1, Convert.ToInt16(2 * CircleCount / TimeSeriesCount), 0, 0.05, 20, 3, true, 0.2,0);
                }
                #endregion
            }
            #endregion
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < TimeSeriesCount;i++ )
            {
                ...
                #region Dorling Displacement
                DM.DorlingBeams(PgList[i], TimeMap, 1, 10, 1, 1, 2 * CircleCount, 0, 0.05, 20, 3, true, 0.2);
                DM.DorlingBeams(PgList[i], TimeMap, 1, 10, 1, 1, 2 * CircleCount, 0, 0.05, 20, 0, true, 0.2);
                #endregion
            }
            #endregion
