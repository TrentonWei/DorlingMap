...
namespace AuxStructureLib
{
    ...
    /// </summary>
         [Serializable]
    public class SDS_Node : Node
    {
        public int ID = -1;
        public int TagID = -1;
        public List<SDS_Edge> Edges = null;
        public List<bool> EdgesD = null;
        public SDS_PointObj PointObj = null;

        public List<SDS_Triangle> Triangles = null;
        ...
        public SDS_Node(int id, int tagID, double x, double y)
        {
            ID = id;
            TagID = tagID;
            X = x;
        ...
        public static void Create_WriteVetex2Shp(string filePath, string fileName, List<SDS_Node> TriNodeList, esriSRProjCS4Type prj)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    feature.set_Value(5, TriNodeList[i].TagID);
